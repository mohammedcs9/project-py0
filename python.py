...
madrab1.shapesize(stretch_wid=5, stretch_len=1) #stretches the shpae to meet the size
...
def madrab2_down():
    ...
    madrab2.sety(y)
#keyboard bindings
wind.listen() #tell the window tp expect keyboard input
...
while True:
    ...
    #border check , top border +300px, bottom border -300px, bal is 20px
